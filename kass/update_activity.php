...
$insert = mysqli_query($conn,
	...
	VALUES ('',
	'$name',
	'FIELD ACTIVITY UPDATED KASS EVENT WITH FOR $md_name $d ($time_start - $time_end) REMARKS: $remarks',
	'$date',
	''
	) 
	") ;
...
$insert = mysqli_query($conn,
	...
	VALUES ('',
	'$name',
	'OFFICE ACTIVITY UPDATED KASS EVENT WITH FOR $md_name $d ($time_start - $time_end) REMARKS: $remarks',
	'$date',
	''
	) 
	") ;
